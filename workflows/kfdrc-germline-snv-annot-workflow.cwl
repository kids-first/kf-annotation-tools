...
steps:
  ...
  bcftools_clinvar_annotate:
    ...
    in:
      input_vcf:
        source: [echtvar_anno_gnomad/annotated_vcf, vep_annotate_vcf/output_vcf, bcftools_strip_info/stripped_vcf, normalize_vcf/normalized_vcf, prefilter_vcf/filtered_vcf, input_vcf]
        pickValue: first_non_null
  ...
  rename_output:
    ...
    in:
      input_files:
        source: [bcftools_clinvar_annotate/bcftools_annotated_vcf, echtvar_anno_gnomad/annotated_vcf,
